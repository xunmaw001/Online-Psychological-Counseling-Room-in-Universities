...
var centerMenu = [
    ...
    ,{
        name: '心理医生收藏',
        url: '../xinliyishengCollection/list.html'
    }
    ,{
        name: '心理医生留言',
        url: '../xinliyishengLiuyan/list.html'
    }
    ,{
        name: '心理医生预约',
        url: '../xinliyishengYuyue/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '心理医生',
        url: './pages/xinliyisheng/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/gaoxiaoxianshangxinlizhixun/admin/dist/index.html#/login";
