            ...
            <el-table :data="forumData" height="250">
                ...
                <el-table-column label="身份">
                    <template slot-scope="scope">
                        <span v-if="scope.row.xinliyishengId">
                            心理医生
                        </span>
                ...
                <el-table-column label="图片">
                    <template slot-scope="scope">
                        <div v-if="scope.row.forumPhoto">
                            <img :src="$base.url+scope.row.forumPhoto" width="100" height="100">
                        </div>
                        <div v-else>无图片</div>
                    </template>
                </el-table-column>
                ...
                <el-table-column property="caozuo" label="操作">
                    <template slot-scope="scope">
                        <el-button type="info"                          @click="seeForumContent(scope.row.forumContent)">回帖详情</el-button>
                            <el-button v-if="true &&( false|| (sessionTable == 'xinliyisheng' && scope.row.xinliyishengId ==userId)
...
|| sessionTable == 'users')" type="danger" icon="el-icon-delete" size="mini" @click="deleteHandler(scope.row.id)">删除帖子</el-button>
            ...
            <div class="demo-input-suffix">
                ...
                <file-upload tip="点击上传图片" action="file/upload" :limit="3" :multiple="true" :fileUrls="forumReplyPhoto?$base.url+forumReplyPhoto:''"
                     @change="forumReplyPhotoUploadChange"></file-upload>
            </div>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/gaoxiaoxianshangxinlizhixun/upload/forumMuBan.xls"
                        >批量导入情感树洞数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
...
<script>
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.xinliyishengId = el.xinliyishengId;//---
                            forum.xinliyishengName = el.xinliyishengName;
                            forum.xinliyishengTypes = el.xinliyishengTypes;
                            forum.xinliyishengPhoto = el.xinliyishengPhoto;
                            forum.xinliyishengJiuzhi = el.xinliyishengJiuzhi;
                            forum.xinliyishengZhugong = el.xinliyishengZhugong;
                            forum.xinliyishengZhiwei = el.xinliyishengZhiwei;
                            forum.xinliyishengContent = el.xinliyishengContent;
                            forum.xinliyishengDelete = el.xinliyishengDelete;
                            ...
                            forum.createTime = el.createTime;
                            forum.forumPhoto = el.forumPhoto;
            ...
            //图片
            forumReplyPhotoUploadChange(fileUrls) {
            this.forumReplyPhoto = fileUrls;
