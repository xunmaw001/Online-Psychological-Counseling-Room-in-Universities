    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.forumPhoto" label="帖子图片" prop="forumPhoto">
                        <file-upload
                                tip="点击上传帖子图片"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.forumPhoto?ruleForm.forumPhoto:''"
                                @change="forumPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.forumPhoto" label="帖子图片" prop="forumPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.forumPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //图片
            forumPhotoUploadChange(fileUrls){
                this.ruleForm.forumPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
