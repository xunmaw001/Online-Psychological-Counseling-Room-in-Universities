    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="xinliyishengLiuyanText">
                        <el-input type="textarea"  :readonly="ro.xinliyishengLiuyanText" v-model="ruleForm.xinliyishengLiuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xinliyishengLiuyanText" label="留言内容" prop="xinliyishengLiuyanText">
                            <span v-html="ruleForm.xinliyishengLiuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.xinliyishengId = true;//心理医生
                this.ro.yonghuId = true;//用户
                this.ro.xinliyishengLiuyanText = true;//留言内容
            }
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `xinliyishengLiuyan/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`xinliyishengLiuyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.xinliyishengLiuyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
