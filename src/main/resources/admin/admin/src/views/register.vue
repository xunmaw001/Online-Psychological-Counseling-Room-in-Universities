    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">高校线上心理咨询室注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="心理医生名称" class="input" v-if="tableName=='xinliyisheng'">
                            <el-input v-model="ruleForm.xinliyishengName" autocomplete="off" placeholder="心理医生名称"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.xinliyishengName)&& 'xinliyisheng'==this.tableName){
...
<style lang="scss" scoped>
	...
	.container {
        ...
        background-image: url(/gaoxiaoxianshangxinlizhixun/img/back-img-bg.jpg);
