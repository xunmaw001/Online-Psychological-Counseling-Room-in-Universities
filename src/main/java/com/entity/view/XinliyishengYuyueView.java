...
public class XinliyishengYuyueView extends XinliyishengYuyueEntity implements Serializable {
	...
	*/
	...
	private String xinliyishengYuyueYesnoValue;
	...
	public XinliyishengYuyueView() {

	}

	public XinliyishengYuyueView(XinliyishengYuyueEntity xinliyishengYuyueEntity) {
		try {
			BeanUtils.copyProperties(this, xinliyishengYuyueEntity);
	...
	* 获取： 预约状态的值
	*/
	public String getXinliyishengYuyueYesnoValue() {
		return xinliyishengYuyueYesnoValue;
	}
	/**
	* 设置： 预约状态的值
	*/
	public void setXinliyishengYuyueYesnoValue(String xinliyishengYuyueYesnoValue) {
		this.xinliyishengYuyueYesnoValue = xinliyishengYuyueYesnoValue;
	}
	...
	public String toString() {
		return "XinliyishengYuyueView{" +
			", xinliyishengYuyueYesnoValue=" + xinliyishengYuyueYesnoValue +
