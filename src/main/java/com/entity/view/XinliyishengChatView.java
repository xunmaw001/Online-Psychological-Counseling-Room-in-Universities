...
public class XinliyishengChatView extends XinliyishengChatEntity implements Serializable {
	...
	*/
	...
	private String xinliyishengChatValue;
	...
	public XinliyishengChatView() {

	}

	public XinliyishengChatView(XinliyishengChatEntity xinliyishengChatEntity) {
		try {
			BeanUtils.copyProperties(this, xinliyishengChatEntity);
	...
	* 获取： 数据类型的值
	*/
	public String getXinliyishengChatValue() {
		return xinliyishengChatValue;
	}
	/**
	* 设置： 数据类型的值
	*/
	public void setXinliyishengChatValue(String xinliyishengChatValue) {
		this.xinliyishengChatValue = xinliyishengChatValue;
	}
	...
	public String toString() {
		return "XinliyishengChatView{" +
			", zhuangtaiValue=" + zhuangtaiValue +
			", xinliyishengChatValue=" + xinliyishengChatValue +
