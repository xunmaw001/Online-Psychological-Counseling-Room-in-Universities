...
public class XinliyishengCollectionView extends XinliyishengCollectionEntity implements Serializable {
	...
	*/
	...
	private String xinliyishengCollectionValue;
	...
	public XinliyishengCollectionView() {

	}

	public XinliyishengCollectionView(XinliyishengCollectionEntity xinliyishengCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, xinliyishengCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getXinliyishengCollectionValue() {
		return xinliyishengCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setXinliyishengCollectionValue(String xinliyishengCollectionValue) {
		this.xinliyishengCollectionValue = xinliyishengCollectionValue;
	}
	...
	public String toString() {
		return "XinliyishengCollectionView{" +
			", xinliyishengCollectionValue=" + xinliyishengCollectionValue +
