...
public class XinliyishengLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public XinliyishengLiuyanEntity() {

	}

	public XinliyishengLiuyanEntity(T t) {
		try {
    ...
    public String toString() {
        return "XinliyishengLiuyan{" +
            ", id=" + id +
            ", xinliyishengId=" + xinliyishengId +
            ", yonghuId=" + yonghuId +
            ", xinliyishengLiuyanText=" + xinliyishengLiuyanText +
