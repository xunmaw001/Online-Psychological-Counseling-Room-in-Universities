    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(forum !=null){
            ...
            //级联表 心理医生
            //级联表
            XinliyishengEntity xinliyisheng = xinliyishengService.selectById(forum.getXinliyishengId());
    ...
    */
    ...
    public R save(@RequestBody ForumEntity forum, HttpServletRequest request){
        ...
        if(false)
            ...
            forum.setXinliyishengId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<ForumEntity> queryWrapper = new EntityWrapper<ForumEntity>()
            ...
            .eq("xinliyisheng_id", forum.getXinliyishengId())
...
//            forum.setUsersId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        logger.info("sql语句:"+queryWrapper.getSqlSegment());
        ForumEntity forumEntity = forumService.selectOne(queryWrapper);
        if("".equals(forum.getForumPhoto()) || "null".equals(forum.getForumPhoto())){
                forum.setForumPhoto(null);
        }
...
//                            forumEntity.setXinliyishengId(Integer.valueOf(data.get(0)));   //心理医生 要改的
//                            forumEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
//                            forumEntity.setForumPhoto("");//详情和图片
